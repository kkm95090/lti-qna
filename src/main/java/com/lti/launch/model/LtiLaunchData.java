...
public class LtiLaunchData {
    ...
    /*
        ...
        ext_content_return_url: https://dev.canvas.lineedu.kr/courses/9/external_content/success/external_tool_dialog

        oauth_consumer_key: 4a11b5426ea776b37fd938cee3ab0694
        oauth_signature_method: HMAC-SHA1
        oauth_timestamp: 1598941201
        oauth_nonce: hh7KYdg5e0g1wliLDc1yVvnxr3fAPv2ZZaWZ5qSSW1I
        oauth_version: 1.0
        oauth_signature: cLILiLhgT4U/NVucNMFpeXXWjt4=
        oauth_callback: about:blank
     */
    public String getExt_content_return_url() {
        return extContentReturnUrl;
    }

    public void setExt_content_return_url(String extContentReturnUrl) {
        this.extContentReturnUrl = extContentReturnUrl;
    }
    ...
    public void setOauth_signature_method(String oauthSignatureMethod) {
    ...
    public void setOauth_timestamp(String oauthTimestamp) {
    ...
    public void setOauth_nonce(String oauthNonce) {
    ...
    public void setOauth_version(String oauthVersion) {
    ...
    private String extContentReturnUrl;
